...
//myTcnter_t puat_bitTcnt[NUMPUATS];
 ...
 myTcnter_t puat_thisBitTcnt[NUMPUATS];
...
void puat_init(uint8_t puatNum)
{
   ...
   while(!tcnter_isItTime(&startTime, BIT_TCNT*20))
   {
      tcnter_update();
   }
 ...
 * /home/meh/_commonCode/anaButtons/0.50-gitHubbing/testMega328p+NonBlocking/_commonCode_localized/polled_uat/0.70/polled_uat.c
 *
