...
# For the ATmega328p, these have defaults and needn't be listed here,
# unless overriding
...
# (Comment it out)
VER_ANABUTTONS = $(notdir $(patsubst %/,%,$(dir $(CURDIR))))
...
### These three also for ANABUTTONS #####
...
# * /home/meh/_commonCode/anaButtons/0.50-gitHubbing/testMega328p+NonBlocking/makefile
# *
